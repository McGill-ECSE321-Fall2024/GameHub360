...
public class GameRequestIntegrationTests {
    ...
    public void testSubmitGameRequest() {
        ...
        assertTrue(responseBody.getCategoryIds().contains(VALID_CATEGORY_ID), "Game request should contain the valid category ID");
    }
    ...
    public void testApproveGameRequestAsEmployeeShouldFail() {
        ...
        assertEquals(HttpStatus.FORBIDDEN, response.getStatusCode(), "Expected FORBIDDEN status when approving as employee");
    }
    ...
    public void testEditGameRequest() {
        ...
        assertEquals("Updated Game Request Edit", updatedRequest.getName(), "Game request name was not updated correctly");
        assertEquals("Updated Description", updatedRequest.getDescription(), "Game request description was not updated correctly");
        assertEquals("http://updatedimage.com/image.jpg", updatedRequest.getImageUrl(), "Game request image URL was not updated correctly");
    }
