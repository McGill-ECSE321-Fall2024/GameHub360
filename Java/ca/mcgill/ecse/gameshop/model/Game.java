...
public class Game extends GameInformation
{
  ...
  public Game(String aName, String aDescription, String aImageURL, String aNameOfX, int aQuantityInStock, String aIsAvailable, int aPrice, GameShop aGameShop, GameCategory... allCategories)
  {
