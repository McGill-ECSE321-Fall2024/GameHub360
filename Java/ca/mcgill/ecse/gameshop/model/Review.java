...
public class Review
{
  ...
  public Review(Date aDate, GameShop aGameShop, CustomerAccount aCustomerAccount, Order aOrder)
  {
    cachedHashCode = -1;
  ...
  public boolean setGameShop(GameShop aGameShop)
  {
    ...
    if (!gameShop.addReview(this))
    {
      gameShop = existingGameShop;
      wasSet = false;
    }
    else
    {
