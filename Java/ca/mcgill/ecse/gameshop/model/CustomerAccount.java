...
public class CustomerAccount extends Account
{
  ...
  public CustomerAccount(String aEmail, String aPassword, GameShop aGameShop)
  {
  ...
  /* Code from template association_AddManyToOne */
  public Order addOrderHistory(Date aDate, GameShop aGameShop, PaymentInformation aPaymentInformation, Game... allGame)
  {
    return new Order(aDate, aGameShop, this, aPaymentInformation, allGame);
  }
